...
constexpr int kNumInputsPerRegister = 8;//32;
...
static void PartialMatrixDotVector8(const int8_t* wi, const double* scales,
  ...
  for (int j = 0; j < num_in; j += 8) {
    ...
    int8x8_t  vw0 = vld1_s8(wi);     // vw0    = w00 w01 w02 w03 w04 w05 w06 w07
    int8x8_t  vw1 = vld1_s8(wi+8);   // vw1    = w10 w11 w12 w13 w14 w15 w16 w17
    int8x8_t  vw2 = vld1_s8(wi+8*2); // vw2    = w20 w21 w22 w23 w24 w25 w26 w27
    int8x8_t  vw3 = vld1_s8(wi+8*3); // vw3    = w30 w31 w32 w33 w34 w35 w36 w37
    int8x8_t  vw4 = vld1_s8(wi+8*4); // vw4    = w40 w41 w42 w43 w44 w45 w46 w47
    int8x8_t  vw5 = vld1_s8(wi+8*5); // vw5    = w50 w51 w52 w53 w54 w55 w56 w57
    int8x8_t  vw6 = vld1_s8(wi+8*6); // vw6    = w60 w61 w62 w63 w64 w65 w66 w67
    int8x8_t  vw7 = vld1_s8(wi+8*7); // vw7    = w70 w71 w72 w73 w74 w75 w76 w77

    int16x8_t vrow0q = vmull_s8(vw0, vu); // vrow0q = vw00.u0 w01.u1 w02.u2 w03.u3 vw04.u4 w05.u5 w06.u6 w07.u7
    int16x8_t vrow1q = vmull_s8(vw1, vu); // vrow1q = vw10.u0 w11.u1 w12.u2 w13.u3 vw14.u4 w15.u5 w16.u6 w17.u7
    int16x8_t vrow2q = vmull_s8(vw2, vu); // vrow2q = vw20.u0 w21.u1 w22.u2 w23.u3 vw24.u4 w25.u5 w26.u6 w27.u7
    int16x8_t vrow3q = vmull_s8(vw3, vu); // vrow3q = vw30.u0 w31.u1 w32.u2 w33.u3 vw34.u4 w35.u5 w36.u6 w37.u7
    int16x8_t vrow4q = vmull_s8(vw4, vu); // vrow4q = vw40.u0 w41.u1 w42.u2 w43.u3 vw44.u4 w45.u5 w46.u6 w47.u7
    int16x8_t vrow5q = vmull_s8(vw5, vu); // vrow5q = vw50.u0 w51.u1 w52.u2 w53.u3 vw54.u4 w55.u5 w56.u6 w57.u7
    int16x8_t vrow6q = vmull_s8(vw6, vu); // vrow6q = vw60.u0 w61.u1 w62.u2 w63.u3 vw64.u4 w65.u5 w66.u6 w67.u7
    int16x8_t vrow7q = vmull_s8(vw7, vu); // vrow7q = vw70.u0 w71.u1 w72.u2 w73.u3 vw74.u4 w75.u5 w76.u6 w77.u7
